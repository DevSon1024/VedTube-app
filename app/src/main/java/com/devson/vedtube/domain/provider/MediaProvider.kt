...
interface MediaProvider {
    suspend fun getTrendingFeed(region: String? = null): Result<PagedResult<Video>>
    ...
    suspend fun getComments(videoId: String, pageToken: String? = null): Result<PagedResult<Comment>>
}
